...
# TODo привести в порядок docker, добавить контейнер для запуска тестов
# TODo проверить через пакет coverage процент покрытия тестами
# TODO внедрить pre-commit и поправить код
